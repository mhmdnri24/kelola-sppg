<div class="flex gap-3" id="app">
    <div class="bg-white p-6 pb-10 rounded shadow w-[74%]">
        ...
        <div class="grid grid-cols-3 gap-3 mb-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Dapur <span class="text-red-500">*</span> </label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Nama Anggaran <span class="text-red-500">*</span></label>
                <input type="text" :class="getFieldClass('nama_anggaran')" placeholder="Input nama anggaran..." v-model="form.nama_anggaran" @blur="validateField('nama_anggaran')">
        ...
        <div class="grid grid-cols-3 gap-3 mb-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">PB <span class="text-red-500">*</span></label>
                <input type="text" :class="getFieldClass('pm_pb')" placeholder="Input porsi besar..." v-model="form.pm_pb" @blur="validateField('pm_pb')" @input="calculateFields">
            ...
            <div>
                ...
                <input type="text" :class="getFieldClass('pm_pk')" placeholder="Input porsi kecil..." v-model="form.pm_pk" @blur="validateField('pm_pk')" @input="calculateFields">
                <p v-if="errors.pm_pk" class="text-red-500 text-xs mt-1">@{{ errors.pm_pk }}</p>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Pagu PB <span class="text-red-500">*</span></label>
                <input type="text" :class="getFieldClass('pagu_pb')" placeholder="Input pagu PB..." v-model="form.pagu_pb" @blur="validateField('pagu_pb')" @input="calculateFields">
        ...
        <div class="grid grid-cols-3 gap-3 mb-6">
            <div>
                ...
                <input type="text" :class="getFieldClass('pagu_pk')" placeholder="Input pagu PK..." v-model="form.pagu_pk" @blur="validateField('pagu_pk')" @input="calculateFields">
                <p v-if="errors.pagu_pk" class="text-red-500 text-xs mt-1">@{{ errors.pagu_pk }}</p>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">HPP PB <span class="text-red-500">*</span></label>
                <input type="text" :class="getFieldClass('hpp_pb')" placeholder="Input HPP PB..." v-model="form.hpp_pb" @blur="validateField('hpp_pb')" @input="calculateFields">
            ...
            <div>
                ...
                <input type="text" :class="getFieldClass('hpp_pk')" placeholder="Input HPP PK..." v-model="form.hpp_pk" @blur="validateField('hpp_pk')" @input="calculateFields">
        ...
        <div class="flex justify-end gap-3">
            ...
            <button v-if="formType=='create'" @click="handleReset" type="button" class="bg-gray-500 hover:bg-gray-600 text-white border-0 rounded-lg px-5 py-2.5 text-sm font-semibold cursor-pointer flex items-center gap-2 shadow-[0_2px_8px_rgba(40,167,69,0.35)] transition-all hover:-translate-y-px">
                Reset
            </button>
        </div>
    ...
    createApp({
        ...
        methods: {
            calculateFields() {
                ...
                this.calculatedFields.margin = this.calculatedFields.pagu_anggaran - this.calculatedFields.limit_belanja;
            },
